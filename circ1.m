...
D.initX1 = [0.607  0.956  0.704  0.375  0.100  0.446  0.861  0.350  0.095  2.000  1.000 ];

%         [theta  rhoZ   muZ    sigZ   lambk  beta ]
D.initX = [0.607  0.956  0.704  0.375  0.446  0.861];
D.initX = [0.704  0.971  0.125  0.245  0.818  0.922];
