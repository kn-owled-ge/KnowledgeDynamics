...
D.initX1 = [0.900  0.305  0.908  0.000  0.291  0.112  0.331  0.276  0.171  0.200  0.876  0.070  0.350  0.000  0.095  2.000  1.000 ];

%         [theta  omega  rhoZ   sigZ   lambK  delN   lambN  alpha  beta ]
D.initX = [0.900  0.305  0.908  0.291  0.331  0.276  0.171  0.400  0.876];
