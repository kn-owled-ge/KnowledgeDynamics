...
D.initX1 = [0.850  0.563  0.962  0.000  0.164  0.112  0.509  0.147  0.589  0.001  0.911  0.070  0.350  0.000  0.095  2.000  1.000 ];

%         [theta  omega  rhoZ   sigZ   lambK  delN   lambN  alpha  beta ]
D.initX = [0.850  0.563  0.962  0.164  0.509  0.147  0.589  0.200  0.911];
D.lbX   = [0.700, 0.100, 0.800, 0.050, 0.050, 0.100, 0.050, 0.001, 0.800];
D.ubX   = [0.990, 0.900, 0.990, 0.900, 0.950, 0.700, 0.950, 0.900, 0.970];
